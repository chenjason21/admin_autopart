              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4 ">
                    ...
                    <div class="card-body">
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">ID Sales</label>
                        <div class="col-md-10">
                          <input class="form-control" type="text" name="id_sales" value="#" />
                        </div>
                      </div>
                      <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                        <div class="col-md-10">
                          <button type="submit" name="tambah_sales" class="btn btn-primary">Tambah Sales</button>
                        </div>
                      </div>
                    </div>
                    </form>
