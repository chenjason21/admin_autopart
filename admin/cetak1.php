...
<body onload="print()">
  ...
  <?php
  if (!empty('tglawal')) { ?>   
     <center><h2>DAFTAR LAPORAN PENJUALAN BARANG</h2> <hr><br> PERIODE PESANAN <b> <?php echo indonesiatgl($awal); ?> S/D <?php echo indonesiatgl($akhir); ?> </b></center>
<?php } else { ?> 
...
<table class="table my-0">
  ...
  <tbody>
   <?php 
    ...
    $data = mysqli_query($con, "SELECT * FROM tb_jurnal_penjualan WHERE tanggal_penjualan BETWEEN '".$_GET['awal']."' and '".$_GET['akhir']."'");
      }
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      $jumlah1[] =$d['total_penjualan'];
      $total_penjualan=array_sum($jumlah1);
 ...
 <th align="center"> </th>
     ...
     <th><strong></strong></th> 
      ...
      <th align="right">Rp. <?php echo number_format($total_penjualan) ; ?></th>
 </tr>
</table>
    <script>
        window.print();
