                    ...
                    <div class="card-body">
                     ...
                     <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." style="margin-bottom: 20px;border: 3px solid #30262621;display: block;padding: 5px;border-radius: 10px;margin-left: 5px;width: 20%; margin-top: 10px">
                      ...
                      <thead>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $sales)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_sales.php?id_sales=<?= $sales['id_sales']; ?>" class="btn btn-info btn-sm">Edit</a>

                                                    <form action="code_sales.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_sales" value="<?=$sales['id_sales'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
                        ...
                        <a class="btn btn-primary" href="cetak_sales.php" role="button" target="_blank" style="margin-top: 20px"> CETAK </a>
