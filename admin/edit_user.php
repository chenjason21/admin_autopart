              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form action="code_user1.php" method="POST">
                        <input type="hidden" name="id_user" value="<?= $user['id_user']; ?>">
                              <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                  ...
                                  <input type="text" name="password_user" value="<?=$user['password_user'];?>" class="form-control">
                                </div>
                                  <div class="mb-3 col-md-12">
                                  <label class="form-label">Level</label>
                                  <input type="text" name="level_user" value="<?=$user['level_user'];?>" class="form-control">
                                </div>
                                <div class="mb-3 col-md-12">
                                  <button type="submit" name="update_user" class="btn btn-primary">Update User
                                  </button>
                                  <a href="list_user.php" class="btn btn-success">Kembali</a>
                                </div>   
                                </div>
                              </div>
