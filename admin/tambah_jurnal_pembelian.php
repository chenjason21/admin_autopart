              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4 ">
                    ...
                    <form action="code_pembelian.php" method="POST" name="autoSumForm">
                    <div class="card-body">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" name="jumlah_pembelian" id="jumlah_pembelian" />
                        </div>
                      </div>                 
                      <div class="mb-3 row">
                        <div class="col-md-10">
                          <button type="submit" name="tambah_jurnal_pembelian" class="btn btn-primary">Tambah Jurnal Pembelian</button>
                        </div>
                      </div>
                    </div>
                    </form>
