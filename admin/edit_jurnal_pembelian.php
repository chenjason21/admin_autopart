  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <div class="layout-page">
          ...
          <!-- / Navbar -->
                          <?php
                            if(isset($_GET['id_jurnal_pembelian']))
                            {
                                $id_jurnal_pembelian = mysqli_real_escape_string($con, $_GET['id_jurnal_pembelian']);
                                $query = "SELECT * FROM tb_jurnal_pembelian WHERE id_jurnal_pembelian='$id_jurnal_pembelian' ";
                                $query_run = mysqli_query($con, $query);

                                if(mysqli_num_rows($query_run) > 0)
                                {
                                    $jurnal_pembelian = mysqli_fetch_array($query_run);
                            ?>
          <!-- Content wrapper -->
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form action="code_pembelian.php" method="POST">
                        <input type="hidden" name="id_jurnal_pembelian" value="<?= $jurnal_pembelian['id_jurnal_pembelian']; ?>">
                              <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                  ...
                                  <input type="text" name="id_jurnal_pembelian" value="<?=$jurnal_pembelian['id_jurnal_pembelian'];?>" class="form-control">
                                </div> 
                                <div class="mb-3 col-md-12">
                                  <label class="form-label">Tanggal Jurnal Pembelian</label>
                                ...
                                <div class="mb-3 col-md-12">
                                  ...
                                  <div class="col-md-10">
                                    ...
                                    <option disabled selected > <?=$jurnal_pembelian['nama_sales'];?></option>
                                        <?php
                                        include 'koneksi.php'; 
                                ...
                                <div class="mb-3 col-md-12">
                                  ...
                                  <input type="text" name="jumlah_barang" value="<?=$jurnal_pembelian['jumlah_barang'];?>" class="form-control" >
                                </div>
                                  <div class="mb-3 col-md-12">
                                  <label class="form-label">Harga Satuan</label>
                                    <div class="input-group">
                                   <span class="input-group-text" id="basic-addon11">Rp</span>
                                  <input type="text" name="harga_satuan" value="<?= number_format($jurnal_pembelian['harga_satuan'],0, ",", ".") ?>" class="form-control"   >
                                  </div>
                                </div>
                                <div class="mb-3 col-md-12">
                                  ...
                                  <div class="input-group">
                                  <span class="input-group-text" id="basic-addon11">Rp</span>
                                  <input type="text" name="jumlah_pembelian" value="<?= number_format($jurnal_pembelian['jumlah_pembelian'],0, ",", ".") ?>" class="form-control">
                                  </div>
                                </div>                               
                                <div class="mb-3 col-md-12">
                                  <button type="submit" name="update_jurnal_pembelian" class="btn btn-primary">Update 
                                  </button>
                                  <a href="list_jurnal_pembelian.php" class="btn btn-success">Kembali</a>
                                </div>   
                                </div>
                              </div>
...
document.autoSumForm.jumlah_pembelian.value = (one * 1) * (two * 1);}
