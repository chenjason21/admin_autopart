              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4 ">
                    ...
                    <form action="code_penjualan.php" method="POST" name="autoSumForm">
                    <div class="card-body">
                      
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">ID Pembelian</label>
                        <div class="col-md-10">
                          <input class="form-control" type="text" name="id_jurnal_pembelian" value="#" />
                        </div>
                      </div>
                      <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" name="jumlah_barang1" onFocus="startCalc();" onBlur="stopCalc();"  />
                        </div>
                      </div>            
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">Harga Satuan</label>
                        <div class="col-md-10">
                          <input class="form-control" type="text" name="harga_satuan1" onFocus="startCalc();" onBlur="stopCalc();"  />
                        </div>
                      </div>
                      <div class="mb-3 row">
...
function calc(){
one = document.autoSumForm.harga_satuan1.value;
two = document.autoSumForm.jumlah_barang1.value;
