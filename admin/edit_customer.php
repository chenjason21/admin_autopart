      ...
      <div class="layout-page">
          ...
          <!-- / Navbar -->
                          <?php
                            ...
                            {
                                $id_customer = mysqli_real_escape_string($con, $_GET['id_customer']);
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form action="code_cust.php" method="POST">
                        <input type="hidden" name="id_customer" value="<?= $customer['id_customer']; ?>">
                              <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                  <button type="submit" name="update_customer" class="btn btn-primary">Update Customer
                                  </button>
                                  <a href="list_customer.php" class="btn btn-success">Kembali</a>
                                </div>   
                                </div>
                              </div>
