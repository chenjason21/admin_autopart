                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $user)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_user.php?id_user=<?= $user['id_user']; ?>" class="btn btn-info btn-sm">Edit</a>

                                                    <form action="code_user1.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_user" value="<?=$user['id_user'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
