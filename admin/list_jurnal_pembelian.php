                          ...
                          <div class="mb-3 row">
                            <div class="col-md-5">
                              <button type="submit" name="btntampil" class="btn btn-primary">Tampilkan</button>
                                <a href="cetak.php?awal=<?=$tglawal;?> && akhir=<?=$tglakhir;?> && sales=<?=$nama_sales;?>"class="btn btn-info">CETAK</a>
                            </div>
                         </div>
                      ...
                      <table class="table table-bordered">
                          ...
                          <tbody id="myTable">
                            ...
                            if(isset($_POST['txttglawal']) && isset($_POST['txttglakhir'])){
                                ...
                                $data = mysqli_query($con, "SELECT * FROM tb_jurnal_pembelian WHERE tanggal_pembelian BETWEEN '".$_POST['txttglawal']."' and '".$_POST['txttglakhir']."'");
                            }
                            ...
                            <td>
                                                    <a href="edit_jurnal_pembelian.php?id_jurnal_pembelian=<?= $d['id_jurnal_pembelian']; ?>" class="btn btn-info btn-sm">Edit</a>

                                                    <form action="code_pembelian.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_jurnal_pembelian" value="<?=$d['id_jurnal_pembelian'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                            </tr>
                              <?php } ?>  
